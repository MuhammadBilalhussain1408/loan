...
<div>
    <table class="table  table-bordered table-hover table-striped" id="">
        ...
        @if(!empty($transaction->total_shares))
            <tr>
                <td>Total Shares</td>
                <td class="text-right">
                    {{number_format($transaction->total_shares,$transaction->share->decimals)}}
                </td>
            </tr>
        @endif
        <tr>
            <td>Amount</td>
            <td class="text-right">
                {{number_format($transaction->amount,$transaction->share->decimals)}}
            </td>
        </tr>
