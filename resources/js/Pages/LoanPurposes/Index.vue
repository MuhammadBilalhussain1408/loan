<template>
    <app-layout>
        ...
        <div class=" mx-auto mb-4 flex justify-between items-center">
            ...
            <inertia-link v-if="can('loans.purposes.create')" class="btn btn-blue"
                          :href="route('loans.purposes.create')">
                <span>Create </span>
                    ...
                    <tr v-for="result in results.data" :key="result.id"
                        ...
                        <td class="border-t w-px pr-2">
                            <div class=" flex items-center space-x-2">
                                <inertia-link v-if="can('loans.purposes.update')"
                                              :href="route('loans.purposes.edit', result.id)"
                                              tabindex="-1" class="text-indigo-600 hover:text-indigo-900">
                                    Edit
                                </inertia-link>
                                <a href="#" v-if="can('loans.purposes.destroy')"
...
export default {
    ...
    data() {
        return {
            ...
            pageDescription: "Manage  Loan Purposes",
    ...
    watch: {
        form: {
            handler: _.debounce(function () {
                ...
                this.$inertia.get(this.route('loans.purposes.index', Object.keys(query).length ? query : {}))
            }, 500),
            deep: true,
        },
    },
    methods: {
        ...
        destroy() {
            ...
            this.$inertia.delete(this.route('loans.purposes.destroy', this.selectedRecord))
