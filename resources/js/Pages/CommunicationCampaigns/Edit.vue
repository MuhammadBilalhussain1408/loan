    ...
    data() {
        return {
            form: this.$inertia.form({
                ...
                savings_product_id: this.communicationCampaign.savings_product_id,
                client_id: this.communicationCampaign.client_id,
                user_id: this.communicationCampaign.user_id,
                loan_officer_id: this.communicationCampaign.loan_officer_id,
                loan_product_id: this.communicationCampaign.loan_product_id,
                ...
                schedule_frequency: this.communicationCampaign.schedule_frequency,
                schedule_frequency_type: this.communicationCampaign.schedule_frequency_type,
