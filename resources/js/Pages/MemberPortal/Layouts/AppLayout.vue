<template>
    ...
    <div>
        ...
        <div class="hidden md:fixed md:inset-y-0 md:flex md:w-64 md:flex-col border-r">
        ...
        <div class="flex flex-1 flex-col md:pl-64">
            <div class="print:hidden sticky top-0 z-10 flex h-16 flex-shrink-0 bg-white shadow">
                <button type="button"
                            ...
                            <transition enter-active-class="transition ease-out duration-100"
                                ...
                                <MenuItems
                                    ...
                                    <MenuItem v-slot="{ active }">
                                        <Link :href="route('portal.user.profile')"
