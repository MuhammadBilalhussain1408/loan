                    ...
                    <table class="pretty displayschedule" id="repaymentschedule" style="margin-top: 20px;">
                        ...
                        <tr>
                            ...
                            <td class="lefthighlightcolheader">
                                {{ $filters.currency(loan_details["principal"], loan_details["decimals"]) }}
                            </td>
                            <td></td>
                            ...
                            <td>{{ $filters.currency(loan_details["disbursement_fees"], loan_details["decimals"]) }}</td>
                            <td>{{ $filters.currency(loan_details["disbursement_fees"], loan_details["decimals"]) }}</td>
                        </tr>
                        <tr v-for="(item,index) in schedules">
                            ...
                            <td class="lefthighlightcolheader"></td>
                            <td>{{ $filters.currency(item['principal'], loan_details["decimals"]) }}</td>
                            <td class="righthighlightcolheader">
                                {{ $filters.currency(item['balance'], loan_details["decimals"]) }}
                            </td>
                            <td class="lefthighlightcolheader">
                                {{ $filters.currency(item['interest'], loan_details["decimals"]) }}
                            </td>
                            <td>{{ $filters.currency(item['fees'], loan_details["decimals"]) }}</td>
                            <td>{{ $filters.currency(2, loan_details["decimals"]) }}</td>
                        </tr>
                        </tbody>
                        ...
                        <tr>
                            ...
                            <th>{{ $filters.currency(loan_details["principal"], loan_details["decimals"]) }}</th>
                            <th class="righthighlightcolheader">&nbsp;</th>
                            <th class="lefthighlightcolheader">
                                {{ $filters.currency(loan_details['total_interest'], loan_details["decimals"]) }}
                            </th>
                            <th>{{ $filters.currency(loan_details["total_fees"], loan_details["decimals"]) }}</th>
                            <th>{{ $filters.currency(loan_details["total_due"], loan_details["decimals"]) }}</th>
                        </tr>
                        </tfoot>
                    </table>
                </div>
