    ...
    <div class="bg-white p-4 shadow rounded">
        <div class="flex justify-between">
            ...
            <div class="flex justify-end mb-4">
                ...
                <button v-if="can('loans.applications.disburse') && (application.status==='approved' || (application?.current_stage?.name=='Board Chairman/Member' && disburseProofs)) && application.status != 'disbursed'" title="Disburse"
