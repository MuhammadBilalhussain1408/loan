    ...
    <app-layout>
        <template #header>
            <h2 class="font-semibold text-xl text-gray-800 leading-tight">
                ...
                <span class="text-indigo-400 font-medium">/</span> Add Loan
            </h2>
        </template>
...
export default {
    ...
    data() {
        return {
            form: this.$inertia.form({
                ...
                fund_id: this.application.product.fund_id,
                loan_purpose_id: null,
                loan_officer_id: this.application.client.loan_officer_id,
                ...
                applied_amount: this.application.amount,
                loan_term: this.application.product.default_loan_term,
                repayment_frequency: this.application.product.repayment_frequency,
                repayment_frequency_type: this.application.product.repayment_frequency_type,
                interest_rate: this.application.product.default_interest_rate,
                selected_charges: [],
            ...
            selectedCharge: null,
            pageTitle: "Approve Loan Application",
            pageDescription: "Approve Loan Application",
        }
    ...
    methods: {
        submit() {
            this.form.post(this.route('loans.applications.store_approve',this.application.id), {})
        ...
        changeClient() {
            this.form.loan_officer_id = this.selectedClient.loan_officer_id;
