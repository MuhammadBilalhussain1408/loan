...
export default {
    ...
    data() {
        return {
            ...
            pageTitle: "Create Loan Application Note",
            pageDescription: "Create Loan Application Note",
    ...
    methods: {
        submit() {
            this.form.post(this.route('loans.applications.notes.store', this.application.id), {})
        },
    },
}
</script>
