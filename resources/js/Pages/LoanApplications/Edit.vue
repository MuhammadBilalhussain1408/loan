                ...
                <form @submit.prevent="submit">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-2 ">
                        <div>
                            ...
                            <span>{{ application.member.name }}</span>
                        </div>
                        <div>
...
export default {
    ...
    data() {
        return {
            form: this.$inertia.form({
                loan_application_checklist_id: this.application.loan_application_checklist_id,
                loan_purpose_id: this.application.loan_purpose_id,
                loan_officer_id: this.application.loan_officer_id,
                member_category_id: this.application.member_category_id,
                member_designation_id: this.application.member_designation_id,
                applied_amount: this.application.applied_amount,
                loan_term: this.application.loan_term,
                repayment_frequency: this.application.repayment_frequency,
                repayment_frequency_type: this.application.repayment_frequency_type,
                interest_rate: this.application.interest_rate,
                selected_charges: this.application.selected_charges,
                custom_fields: this.application.custom_fields,
            }),
            usersMultiSelect: {
            ...
            selectedMember: this.application.member,
            selectedProduct: this.application.product,
            selectedCharge: null,
            pageTitle: "Edit Loan Application",
            pageDescription: "Edit Loan Application",
        }
    ...
    methods: {
        submit() {
            this.form.put(this.route('loans.applications.update', this.application.id), {})
