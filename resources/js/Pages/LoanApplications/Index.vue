<template>
    <app-layout>
        ...
        <div class=" mx-auto mb-4 flex justify-between items-center">
            ...
            <inertia-link class="btn btn-blue" :href="route('loans.applications.create')">
                <span>Create </span>
            ...
            <div class="bg-white rounded shadow overflow-x-auto">
                <table class="w-full whitespace-no-wrap">
                    ...
                    <tr class="text-left font-bold">
                        ...
                        <th class="px-6 pt-4 pb-4 font-medium text-gray-500">Next Stage</th>
                        <th class="px-6 pt-4 pb-4 font-medium text-gray-500">Status</th>
                        <th class="px-6 pt-4 pb-4 font-medium text-gray-500">Application Date</th>
                    ...
                    <tr v-for="result in results.data" :key="result.id"
                        ...
                        <td class="border-t">
                           <span class="px-6 py-4 flex items-center" v-if="result.next_stage">
                                {{ result.next_stage.stage?.name }}
                            </span>
                        </td>
                        ...
                        <td class="border-t w-px pr-2">
                            <div class=" flex items-center gap-4">
                                ...
                                <inertia-link v-if="can('loans.applications.destroy') && result.status!=='approved'"
                                              :href="route('loans.applications.edit', result.id)"
                                              tabindex="-1" class="text-green-600 hover:text-green-900" title="Edit">
                                    <font-awesome-icon icon="edit"/>
                                </inertia-link>
                                <a href="#" v-if="can('loans.applications.destroy') && result.status==='pending'"
    ...
    watch: {
        form: {
            handler: _.debounce(function () {
                ...
                this.$inertia.get(this.route('loans.applications.index', Object.keys(query).length ? query : {}))
            }, 1000),
            deep: true,
        },
    },
