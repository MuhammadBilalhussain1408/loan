            ...
            <div class="p-4 bg-white">
                <div class="flex justify-end ">
                    <inertia-link class="btn btn-blue" v-if="can('loans.files.create')"
                                  :href="route('loans.applications.files.create',application.id)">
                        <span>Add </span>
                            ...
                            <td class="border-t w-px pr-2">
                                <div class=" flex items-center space-x-2">
                                    ...
                                    <inertia-link v-if="can('loans.files.update')"
                                                  :href="route('loans.applications.files.edit', file.id)"
                                                  tabindex="-1" class="text-indigo-600 hover:text-indigo-900">
                                        Edit
                                    </inertia-link>
...
export default {
    ...
    data() {
        return {
            ...
            processing: false,
            action: '',
            pageTitle: "Loan Application Files",
            pageDescription: "Loan Application Files",
        }
    ...
    methods: {
        ...
        destroy() {
            ...
            this.$inertia.delete(this.route('loans.applications.files.destroy', this.selectedRecord), {
                preserveState: false
            })
