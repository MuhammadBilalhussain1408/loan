<template>
    <app-layout>
        ...
        <div class=" mx-auto mb-4 flex justify-between items-center">
            ...
            <inertia-link v-if="can('loans.checklists.create')" class="btn btn-blue"
                          :href="route('loans.checklists.create')">
                <span>Create </span>
                    ...
                    <tr v-for="item in results.data" :key="item.id"
                        ...
                        <td class="border-t w-px pr-2">
                            <div class=" flex items-center space-x-2">
                                <inertia-link v-if="can('loans.checklists.update')"
                                              :href="route('loans.checklists.edit', item.id)"
                                              tabindex="-1" class="text-indigo-600 hover:text-indigo-900">
                                    Edit
                                </inertia-link>
                                <a href="#" v-if="can('loans.checklists.destroy')"
...
export default {
    ...
    data() {
        return {
            ...
            selectedRecord: null,
            pageTitle: "Application Checklists",
            pageDescription: "Manage Application Checklists",
    ...
    watch: {
        form: {
            handler: _.debounce(function () {
                ...
                this.$inertia.get(this.route('loans.checklists.index', Object.keys(query).length ? query : {}))
            }, 500),
            deep: true,
        },
    },
    methods: {
        ...
        destroy() {
            ...
            this.$inertia.delete(this.route('loans.checklists.destroy', this.selectedRecord))
