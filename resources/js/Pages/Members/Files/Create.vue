            ...
            <div class="md:flex md:items-start">
                ...
                <div class="w-full md:w-9/12 p-4 md:ml-4 bg-white sm:mt-4">
                    <div class="flex justify-between ">
                        <h2 class="font-semibold text-xl text-gray-800 leading-tight">Create File</h2>
...
export default {
    ...
    data() {
        return {
            ...
            pageTitle: "Create Member File",
            pageDescription: "Create Member File",
    ...
    methods: {
        submit() {
            this.form.post(this.route('members.files.store', this.member.id), {})
        },
    },
}
</script>
