            ...
            <div class="md:flex md:items-start">
                ...
                <div class="w-full md:w-9/12 p-4 md:ml-4 bg-white sm:mt-4">
                    <div class="flex justify-between ">
                        <h2 class="font-semibold text-xl text-gray-800 leading-tight">Create Identification</h2>
...
export default {
    ...
    data() {
        return {
            form: this.$inertia.form({
                member_identification_type_id: null,
                identification_value: null,
                status: 'pending',
                file: null,
                description: null,
            }),
            pageTitle: "Create Member Identification",
            pageDescription: "Create Member Identification",
    ...
    methods: {
        submit() {
            this.form.post(this.route('members.identifications.store', this.member.id), {})
        },
    },
}
</script>
