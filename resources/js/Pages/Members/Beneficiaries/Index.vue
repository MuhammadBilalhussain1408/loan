            ...
            <div class="md:flex md:items-start">
                ...
                <div class="w-full md:w-9/12 p-4 md:ml-4 bg-white sm:mt-4">
                    <div class="flex justify-between ">
                        ...
                        <inertia-link class="btn btn-blue" v-if="can('members.beneficiaries.create')"
                                      :href="route('members.beneficiaries.create',member.id)">
                            <span>Create </span>
                            ...
                            <tr v-for="beneficiary in beneficiaries.data" :key="beneficiary.id"
                                ...
                                <td class="border-t w-px pr-2">
                                    <div class=" flex items-center space-x-2">
                                        <inertia-link v-if="can('members.beneficiaries.update')"
                                                      :href="route('members.beneficiaries.edit', beneficiary.id)"
                                                      tabindex="-1" class="text-indigo-600 hover:text-indigo-900">
                                            Edit
                                        </inertia-link>
                                        <a href="#" v-if="can('members.beneficiaries.destroy')"
                                           @click="deleteAction(beneficiary.id)"
