<template>
    <app-layout>
        ...
        <div class=" mx-auto mb-4 flex justify-between items-center">
            ...
            <inertia-link v-if="can('files.types.create')" class="btn btn-blue"
                          :href="route('files.types.create')">
                <span>Create </span>
                    ...
                    <tr v-for="result in results.data" :key="result.id"
                        ...
                        <td class="border-t w-px pr-2">
                            <div class=" flex items-center space-x-2">
                                <inertia-link v-if="can('files.types.update')"
                                              :href="route('files.types.edit', result.id)"
                                              tabindex="-1" class="text-indigo-600 hover:text-indigo-900">
                                    Edit
                                </inertia-link>
                                <a href="#" v-if="can('files.types.destroy')"
...
export default {
    ...
    data() {
        return {
            ...
            pageDescription: "Manage File Types",
    ...
    watch: {
        form: {
            handler: _.debounce(function () {
                ...
                this.$inertia.get(this.route('files.types.index', Object.keys(query).length ? query : {}))
            }, 500),
            deep: true,
        },
    },
    methods: {
        ...
        destroy() {
            ...
            this.$inertia.delete(this.route('clients.types.destroy', this.selectedRecord))
