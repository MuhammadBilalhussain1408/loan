<template>
    <app-layout>
        ...
        <div class=" mx-auto mb-4 flex justify-between items-center">
            ...
            <inertia-link v-if="can('loans.funds.create')" class="btn btn-blue"
                          :href="route('loans.funds.create')">
                <span>Create </span>
                <span class="hidden md:inline">Fund</span>
            </inertia-link>
        </div>
        <div class=" mx-auto">
                    ...
                    <tr v-for="result in results.data" :key="result.id"
                        ...
                        <td class="border-t w-px pr-2">
                            <div class=" flex items-center space-x-2">
                                <inertia-link v-if="can('loans.funds.update')"
                                              :href="route('loans.funds.edit', result.id)"
                                              tabindex="-1" class="text-indigo-600 hover:text-indigo-900">
                                    Edit
                                </inertia-link>
                                <a href="#" v-if="can('loans.funds.destroy')"
...
export default {
    ...
    watch: {
        form: {
            handler: _.debounce(function () {
                ...
                this.$inertia.get(this.route('loans.funds.index', Object.keys(query).length ? query : {}))
            }, 500),
            deep: true,
        },
    },
    methods: {
        ...
        destroy() {
            ...
            this.$inertia.delete(this.route('loans.funds.destroy', this.selectedRecord))
