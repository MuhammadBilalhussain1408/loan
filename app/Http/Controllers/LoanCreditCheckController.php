...
class LoanCreditCheckController extends Controller
{
    public function __construct()
    {
        ...
        $this->middleware(['permission:loans.credit_checks.index'])->only(['index','show']);
        $this->middleware(['permission:loans.credit_checks.create'])->only(['create','store']);
        $this->middleware(['permission:loans.credit_checks.edit'])->only(['edit','update']);
        $this->middleware(['permission:loans.credit_checks.destroy'])->only(['destroy']);
    ...
    public function index()
    {
        ...
        return Inertia::render('loan::credit_check.index', compact('data'));
    }
    ...
    public function show($id)
    {
        ...
        return Inertia::render('loan::credit_check.show',compact('loan_credit_check'));
    }
    ...
    {
        $loan_credit_check = LoanCreditCheck::find($id);
        return Inertia::render('loan::credit_check.edit',compact('loan_credit_check'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect('loan/credit_check');
    }
