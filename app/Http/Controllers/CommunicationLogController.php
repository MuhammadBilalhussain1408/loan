...
class CommunicationLogController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return Inertia::render('communication::log.index', compact('data', 'status', 'campaign_type'));
    }
    ...
    public function show($id)
    {
        ...
        return Inertia::render('communication::log.show', compact('communication_campaign_log'));
    }
